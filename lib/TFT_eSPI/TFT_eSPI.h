...
**                         第5节：字体基准点枚举
***************************************************************************************/
// 这些枚举了文本绘制的对齐方式（参考基准点）
#define TL_DATUM 0    // 左上角（默认）
#define TC_DATUM 1    // 顶中
#define TR_DATUM 2    // 右上角
#define ML_DATUM 3    // 中左
#define CL_DATUM 3    // 中心左，与上方相同
#define MC_DATUM 4    // 中心
#define CC_DATUM 4    // 中心中心，与上方相同
#define MR_DATUM 5    // 中右
#define CR_DATUM 5    // 中心右，与上方相同
#define BL_DATUM 6    // 左下角
#define BC_DATUM 7    // 底中
#define BR_DATUM 8    // 右下角
#define L_BASELINE 9  // 左字符基线（字符 'A' 所在的线）
#define C_BASELINE 10 // 中心字符基线
#define R_BASELINE 11 // 右字符基线

/***************************************************************************************
**                         第6节：颜色枚举
***************************************************************************************/
// 默认颜色定义
#define TFT_BLACK 0x0000 /*   0,   0,   0 */       // 黑色
#define TFT_NAVY 0x000F /*   0,   0, 128 */        // 海军蓝
#define TFT_DARKGREEN 0x03E0 /*   0, 128,   0 */   // 深绿色
#define TFT_DARKCYAN 0x03EF /*   0, 128, 128 */    // 深青色
#define TFT_MAROON 0x7800 /* 128,   0,   0 */      // 栗色
#define TFT_PURPLE 0x780F /* 128,   0, 128 */      // 紫色
#define TFT_OLIVE 0x7BE0 /* 128, 128,   0 */       // 橄榄色
...
#define TFT_RED 0xF800 /* 255,   0,   0 */         // 红色
#define TFT_MAGENTA 0xF81F /* 255,   0, 255 */     // 洋红色
#define TFT_YELLOW 0xFFE0 /* 255, 255,   0 */      // 黄色
#define TFT_WHITE 0xFFFF /* 255, 255, 255 */       // 白色
#define TFT_ORANGE 0xFDA0 /* 255, 180,   0 */      // 橙色
#define TFT_GREENYELLOW 0xB7E0 /* 180, 255,   0 */ // 黄绿色
#define TFT_PINK 0xFE19 /* 255, 192, 203 */        // 粉红色（较亮），之前为 0xFC9F
#define TFT_BROWN 0x9A60 /* 150,  75,   0 */       // 棕色
#define TFT_GOLD 0xFEA0 /* 255, 215,   0 */        // 金色
#define TFT_SILVER 0xC618 /* 192, 192, 192 */      // 银色
#define TFT_SKYBLUE 0x867D /* 135, 206, 235 */     // 天蓝色
#define TFT_VIOLET 0x915C /* 180,  46, 226 */      // 紫罗兰色

// 下面是一个特殊的 16 位颜色值，它可以编码为 8 位，
// 然后再解码回相同的 16 位值。
// 对于 8 位和 16 位透明精灵非常方便。
#define TFT_TRANSPARENT 0x0120 // 实际上这是一个深绿色
...
static const uint16_t default_4bit_palette[] PROGMEM = {
    ...
    TFT_WHITE,     //  9  v
    TFT_CYAN,      // 10  蓝+绿混合
    TFT_MAGENTA,   // 11  蓝+红混合
    TFT_MAROON,    // 12  更深的红色
    TFT_DARKGREEN, // 13  更深的绿色
    TFT_NAVY,      // 14  更深的蓝色
    TFT_PINK       // 15
};
