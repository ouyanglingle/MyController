...
***************************************************************************************/
// x,y 是完整圆角矩形边界框的左上角坐标
// r = 外部圆角半径，ir = 内部圆角半径。弧线厚度 = r - ir + 1
// w 和 h 是边界框的宽度和高度
// 如果 w 和 h 小于半径（例如 0,0），将绘制一个中心在 x+r, y+r 的圆形
// 前景色 fg_color 在边缘处使用抗锯齿与背景色混合
// 可以通过指定象限掩码来绘制部分圆角（如果未提供参数则绘制所有四个角）：
//   0x1 | 0x2
//    ---+---
//   0x8 | 0x4
// 圆角掩码选择位（如 drawCircleHelper 函数中的定义）
